define(['../connectionUtility', '../userTestUtility'], function (ConnectionUtility, UserTestUtility)
{
    ...
    {
        this.name = 'Game Manager Login Test';
    }

    GameManagerTest.prototype.scenarioSetupAsync = function (finishedCallback)
    {
    ...
    GameManagerTest.prototype.scenarioTearDown = function ()
    {
        ConnectionUtility.disconnect();
    }

    GameManagerTest.prototype.testLoginPasswordMustMatch = function ()
    {
    ...
    GameManagerTest.prototype.testLoginUserDoesNotExist = function ()
    {
        var testComplete = false;
    ...
    GameManagerTest.prototype.testLoginSuccess = function ()
    {
        var testComplete = false;
