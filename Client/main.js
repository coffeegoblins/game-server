require(['Core/src/domEvents', 'Core/src/scheduler', 'Core/src/commandManager', 'Renderer/src/menus/mainMenu', 'Core/src/utility'],
    function (DomEvents, Scheduler, CommandManager, MainMenu, Utility)
    {
        'use strict';
