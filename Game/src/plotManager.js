define(['renderer', 'Game/src/scheduler', 'Game/src/levelLoader', 'Game/src/turnManager', 'Game/src/pathManager', 'Renderer/src/ui/actionBarView', 'Renderer/src/ui/activeUnitView'],
function (Renderer, Scheduler, LevelLoader, TurnManager, PathManager, ActionBarView, ActiveUnitView)
{
    'use strict';
    ...
    PlotManager.prototype.onTileSelected = function(selectedTile, tileX, tileY)
    {
        ...
        if (this.activePath)
        {
            ...
            ActionBarView.addActions([{id: "Move", method: this.onMoveAction, context: this}]);
        }
    };
